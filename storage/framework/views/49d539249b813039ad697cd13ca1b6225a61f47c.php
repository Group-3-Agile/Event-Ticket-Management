...
<script>
        ...
        const authAPI = <?php echo json_encode($authAPIKEY); ?>

        console.log(authAPI)
        const std = <?php echo json_encode($student_channels); ?>;
    ...
    function retrieveLatestNotification()
    {
        ...
        xhttp.open("POST", "<?php echo e(route('notification.ajax.latest')); ?>", true);
    ...
    {
        let url =  tempNot.data['routing'] === 'user' ? '<?php echo e(route("users.show", ':ids')); ?>' : (tempNot.data['routing'] === 'commi' ? '<?php echo e(route("commi.community", ":ids")); ?>':'<?php echo e(route("event.show", ":ids")); ?>' );
...
<script>
    ...
    {
        var xhttp = new XMLHttpRequest();
        xhttp.open("POST", "<?php echo e(route('notification.ajax.unmarked')); ?>", true);
    ...
    function responseRequest(id, responseText)
    {
        $.ajax(
            {
                url: "<?php echo e(route('notification.ajax.reply')); ?>",
                type: "POST",
                data:
                    {
                        id: id,
...
<?php /**PATH C:\Users\USER\xampp\htdocs\system\resources\views/includes/globalconfig.blade.php ENDPATH**/ ?>