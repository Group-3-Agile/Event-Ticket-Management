            ...
            <div class="col-lg-12">
                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile"
                    ...
                    <div class="kt-portlet__body">
                        <form class="kt-form" id="user-form" action="<?php echo e(route('users.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                    ...
                                    <div class="kt-section kt-section--first">
                                        <div class="kt-section__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <div class="kt-uppy <?php $__errorArgs = ['profile_image_path'];
...
unset($__errorArgs, $__bag); ?>" id="kt_uppy_3">
                                                    ...
                                                    <?php $__errorArgs = ['profile_image_path'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input class="form-control <?php $__errorArgs = ['ic_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                           ...
                                                           value="<?php echo e(old('ic_number')); ?>">
                                                    <?php $__errorArgs = ['ic_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <textarea class="form-control <?php $__errorArgs = ['biography'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="biography" placeholder="Biography" rows="3" maxlength="200"><?php echo e(old('biography')); ?></textarea>
...
<?php $__env->startSection('pagevendorsscripts'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/pages/crud/forms/widgets/input-mask.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\xampp\htdocs\system\resources\views/superadmin/users/create.blade.php ENDPATH**/ ?>