        ...
        var KTDatatablesSearchOptionsColumnSearch = function () {
            ...
            var initTable1 = function () {
                var table = $('#user_table').DataTable({
                    ...
                    ajax: {
                        url: '<?php echo e(route('ajax.users.index')); ?>',
                        type: "POST",
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            orderable: false,
                            render: function (data, type, full, meta) {
                                var editURL = '<?php echo e(route('users.edit', ':data')); ?>';
                                var showURL = '<?php echo e(route('users.show', ':data')); ?>';
                ...
                $('#kt_modal_fetch_id_server').on('show.bs.modal', function (e) {
                    ...
                    var url = '<?php echo e(route("users.destroyMany", ':ids')); ?>';
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\xampp\htdocs\system\resources\views/superadmin/users/index.blade.php ENDPATH**/ ?>