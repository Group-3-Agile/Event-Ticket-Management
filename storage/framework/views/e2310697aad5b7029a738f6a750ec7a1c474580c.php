...
<?php $__env->startSection('subheader', 'Home'); ?>
<?php $__env->startSection('subheader-link', route('home')); ?>

<?php $__env->startSection('subheader-action', ''); ?>
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="row">
            <div class="col-lg-12 col-xl-12 order-lg-12 order-xl-12">
                                    ...
                                    <div class="kt-widget17__items">
                                        <div class="kt-widget17__item">
                                            ...
                                            <span class="kt-widget17__desc">
                                                                    <?php echo e($widget['userCount']); ?> Total Users
                                                                </span>
                                        </div>
                                        <div class="kt-widget17__item">
                                                                <span class="kt-widget17__icon">
                                            ...
                                            <span class="kt-widget17__desc">
                                                                    <?php echo e($widget['communityCount']); ?> Total Communites
                                                                </span>
                                        </div>
                                    </div>
                                    <div class="kt-widget17__items">
                                        <div class="kt-widget17__item">
                                            ...
                                            <span class="kt-widget17__desc">
                                                                    <?php echo e($widget['eventCount']); ?> Total Events
                                                                </span>
                                        </div>
                                        <div class="kt-widget17__item">
                                                                <span class="kt-widget17__icon">
                                            ...
                                            <span class="kt-widget17__desc">
                                                                    <?php echo e($widget['venueCount']); ?> Total Users
                                                                </span>
                                        </div>
                                    </div>
                                </div>
                ...
                <?php else: ?>
                    <?php if(auth()->check() && auth()->user()->hasRole('community-admin')): ?>
                        <!--begin:: Widgets/Activity-->
                        <div class="kt-portlet kt-portlet--fit kt-portlet--head-lg kt-portlet--head-overlay kt-portlet--skin-solid kt-portlet--height-fluid">
                            <div class="kt-portlet__head kt-portlet__head--noborder kt-portlet__space-x">
                                <div class="kt-portlet__head-label">
                                    ...
                                    <div class="kt-widget17__stats">
                                        ...
                                        <div class="kt-widget17__items">
                                            <div class="kt-widget17__item">
                                                ...
                                                <span class="kt-widget17__desc">
                                                            <?php echo e($widget['communityManagedCount']); ?> Communites
                                                        </span>
                                            </div>
                                            <div class="kt-widget17__item">
                                                            <span class="kt-widget17__icon">
                                                ...
                                                <span class="kt-widget17__desc">
                                                                <?php echo e($widget['eventManagedCount']); ?> Events
                                                            </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="kt-widget17__stats">
                                        ...
                                        <div class="kt-widget17__items">
                                            <div class="kt-widget17__item">
                                                ...
                                                <span class="kt-widget17__desc">
                                                        <?php echo e($widget['communityJoinedCount']); ?> Communites
                                                    </span>
                                            </div>
                                            <div class="kt-widget17__item">
                                                        <span class="kt-widget17__icon">
                                                ...
                                                <span class="kt-widget17__desc">
                                                            <?php echo e($widget['eventJoinedCount']); ?> Events
                                                        </span>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        var KTDashboard = function() {
            ...
            var activitiesChart = function() {
                ...
                $.get("<?php echo e(route('ajax.home.chart')); ?>", function(response) {
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\xampp\htdocs\system\resources\views/home.blade.php ENDPATH**/ ?>