...
<?php $__env->startSection('subheader-action', 'List'); ?>
...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="<?php echo e(route('venues.create')); ?>" class="btn btn-brand btn-elevate btn-icon-sm">
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('venue.delete')): ?>
    <!--begin::Modal-->
    ...
    <script>
        ...
        var KTDatatablesSearchOptionsColumnSearch = function () {
            ...
            var initTable1 = function () {
                var table = $('#venue_table').DataTable({
                    ...
                    ajax: {
                        url: '<?php echo e(route('ajax.venues.index')); ?>',
                        type: "POST",
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            orderable: false,
                            render: function (data, type, full, meta) {
                                var editURL = '<?php echo e(route('venues.edit', ':data')); ?>';
                                var showURL = '<?php echo e(route('venues.show', ':data')); ?>';
                ...
                $('#kt_modal_fetch_id_server').on('show.bs.modal', function (e) {
                    ...
                    var url = '<?php echo e(route("venues.destroyMany", ':ids')); ?>';
        ...
        $(document).ready(function () {
            ...
            $('#modal-delete').on('show.bs.modal', function (e) {
                var url = '<?php echo e(route("venues.destroy", ':id')); ?>';
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\xampp\htdocs\system\resources\views/superadmin/venues/index.blade.php ENDPATH**/ ?>