                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            <a href="<?php echo e(route('communities.create')); ?>" class="btn btn-brand btn-elevate btn-icon-sm">
    ...
    <script>
        ...
        var KTDatatablesSearchOptionsColumnSearch = function () {
            ...
            var initTable1 = function () {
                var table = $('#community_table').DataTable({
                    ...
                    ajax: {
                        url: '<?php echo e(route('ajax.communities.index')); ?>',
                        type: "POST",
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            orderable: false,
                            render: function (data, type, full, meta) {
                                var editURL = '<?php echo e(route('communities.edit', ':data')); ?>';
                                var showURL = '<?php echo e(route('communities.show', ':data')); ?>';
                ...
                $('#kt_modal_fetch_id_server').on('show.bs.modal', function (e) {
                    ...
                    var url = '<?php echo e(route("communities.destroyMany", ':ids')); ?>';
        ...
        $(document).ready(function () {
            ...
            $('#modal-delete').on('show.bs.modal', function (e) {
                var url = '<?php echo e(route("communities.destroy", ':id')); ?>';
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\xampp\htdocs\system\resources\views/superadmin/communities/index.blade.php ENDPATH**/ ?>